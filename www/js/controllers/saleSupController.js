...
app.controller('SaleSupController', function ($scope, $rootScope, $timeout, $stateParams, $state, $modal, $log, $interval, $q, $stickyState, $translate,
    ...
    $scope.duplicateOrder = function (order) {
        ...
        $stickyState.reset('tabs.sale-sup-order');
        $state.go('tabs.sale-sup-order', { }, { reload: true });
    }
    /////// END ORDER DETAIL
    ////////// BEGIN SALE INFO
